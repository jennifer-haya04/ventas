 ...
 * @author jennifer
 */
public class IFrmTipoDocVenta extends javax.swing.JInternalFrame {

    TipoDocVentaLogic logic = null;
    ...
    public IFrmTipoDocVenta() {
        initComponents();
        this.setTitle(rb.getString("titulo_tipoDocVenta"));
    }
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        logic = new TipoDocVentaLogic();
        TipoDocVenta objDoc = getTipoDoc();
        objDoc.setId_tipo_doc(0);
        
        try {
            logic.insertar(objDoc);
    ...
    if(cboPaginacion.getSelectedIndex() == 0){
        JOptionPane.showMessageDialog(null, "Debe seleccionar un Número para la Paginación!");
    }else{
        try {
            if(cboPaginacion.getSelectedIndex() >= 0){
